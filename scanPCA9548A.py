...
while True:
 	...
 	tca9545.write_control_register(TCA9548A_CONFIG_BUS0)
	...
	time.sleep(5.0)
 	...
 	tca9545.write_control_register(TCA9548A_CONFIG_BUS1)
	# read the control register back
	control_register = tca9545.read_control_register()
	print "tca9545 control register B3-B0 = 0x%x"% (control_register & 0x0f )
	print "ignore Interrupts if INT3' - INT0' not connected"
	...
	time.sleep(5.0)
 	...
 	tca9545.write_control_register(TCA9548A_CONFIG_BUS3)
	# read the control register back
	control_register = tca9545.read_control_register()
	print "tca9545 control register B3-B0 = 0x%x"% (control_register & 0x0f )
	print "ignore Interrupts if INT3' - INT0' not connected"
